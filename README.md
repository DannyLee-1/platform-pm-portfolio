...
<td width="33%" align="center"><strong>🚀 MVP까지 구현</strong><br/><br/>PRD와 화면 설계에 머물지 않고<br/>직접 확인할 수 있는 검증용 MVP로 연결합니다.</td>
</tr>
</table>
...
**부트캠프 3인 팀 프로젝트 · 실제 운영 서비스가 아닌 제품 가설 검증용 MVP입니다.**

<table width="100%">
<tr><th width="16%" align="left">구분</th><th align="left">내용</th></tr>
<tr><td><strong>역할</strong></td><td>부트캠프 3인 팀 프로젝트 리더 · 문제 정의 및 서비스 설계 리드</td></tr>
<tr><td><strong>문제</strong></td><td>사용자는 필요한 역할을 설명하기 어렵고, 후보의 신뢰도와 합류 조건을 판단하기 어려움</td></tr>
<tr><td><strong>검증</strong></td><td>개발·디자인 경험이 거의 없는 비전문가 6명 설문 · 공개 실증 자료를 통한 공급자 가설 검토</td></tr>
...
<tr><td><strong>결과</strong></td><td>회원가입부터 프로젝트 구체화·후보 선택·합류 합의까지 핵심 여정 구현 · 검증용 MVP Vercel 배포</td></tr>
</table>
...
> 추천 결과와 데모 지표는 제품 가설을 확인하기 위한 시나리오이며, 실제 운영 성과가 아닙니다.
...
> 시민 의식의 문제가 아니라, 필요한 순간을 알 수 없게 만든 시스템의 문제로 다시 정의했습니다.
...
<tr><td><strong>실행</strong></td><td>1분 자동 소등 · 시민 자율 교정 · 유지관리 · 접근성 · 좌석당 약 20만 원의 추정 원가 설계</td></tr>
...
<tr>
<td valign="top"><strong>잘못된 문제부터 만들지 않습니다.</strong><br/><br/>해결책보다 먼저 “진짜 문제”를 되묻습니다.</td>
<td valign="top"><strong>가장 위험한 가설부터 확인합니다.</strong><br/><br/>논리의 빈틈과 실패 조건을 먼저 찾습니다.</td>
<td valign="top"><strong>문서에서 멈추지 않습니다.</strong><br/><br/>사용자가 움직이는 화면과 흐름으로 검증합니다.</td>
</tr>
</table>
